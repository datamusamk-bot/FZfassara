...
# PURE OFFLINE PYDROID3 SQLITE DATABASE CONFIGURATION MATRIX
...
# Privacy Policy Page Framework for Play Store Validation
@app.route('/privacy')
def privacy():
    return render_template('privacy.html')

# Terms of Service Page Framework for Play Store Validation
@app.route('/terms')
def terms():
